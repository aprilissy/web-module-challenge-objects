...
const salmonDinner = createMenuItem("Salmon", 22, "Dinner");
const lemonade = createMenuItem("Lemonade", 3.5, "Drinks");
const hotDog = createMenuItem("Hot Dog", 14, "Lunch")
...
function getLastReview(reviewsArr) {
  const index = reviewsArr.length - 1;
  return `${reviewsArr[index].name} gave the restaurant a ${reviewsArr[index].rating}, and their feedback was: ${reviewsArr[index].feedback}`;
}
